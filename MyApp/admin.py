...
def safe_register(model_name, admin_class=None):
    """Register a model with admin only if it exists in models.py."""
...
@admin.register(models.Marker) if hasattr(models, "Marker") else (lambda x: x)
...
@admin.register(models.UserLocation) if hasattr(models, "UserLocation") else (lambda x: x)
...
@admin.register(models.Task) if hasattr(models, "Task") else (lambda x: x)
...
@admin.register(models.Location) if hasattr(models, "Location") else (lambda x: x)
class LocationAdmin(admin.ModelAdmin):
    list_display = ("name", "latitude", "longitude")
    search_fields = ("name",)


@admin.register(models.UserProfile) if hasattr(models, "UserProfile") else (lambda x: x)
...
@admin.register(models.Friendship) if hasattr(models, "Friendship") else (lambda x: x)
...
@admin.register(models.ProximityAlert) if hasattr(models, "ProximityAlert") else (lambda x: x)
...
@admin.register(models.ProximityNotification) if hasattr(models, "ProximityNotification") else (lambda x: x)
